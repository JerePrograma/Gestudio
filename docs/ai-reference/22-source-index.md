...
| Estado remoto | 27 | GitHub `main`, commits y PRs | CONFIRMADO |
...
| API total | 08 | `SecurityHttpIntegrationTest.discoverEndpoints` | CONFIRMADO |
...
| Jere Platform | 11 | controller, service, integración v1 | CONFIRMADO |
| Email | 11 | `EmailService`, `NoOpEmailService` | CONFIRMADO |
...
| Riesgos | 18 | fuentes anteriores | CONFIRMADO/PARCIAL |

## Fecha y alcance

Todas las filas se revisaron el 24-07-2026 contra el `main` remoto anterior al commit de esta actualización. El índice no sustituye una búsqueda de usos antes de editar.
