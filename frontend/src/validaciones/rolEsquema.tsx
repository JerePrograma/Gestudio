...
export const rolEsquema = Yup.object().shape({
  codigo: Yup.string()
    ...
    .test("sin-prefijo-role", "No use el prefijo ROLE_", (value) =>
      !value?.trim().toUpperCase().startsWith("ROLE_"))
  ...
  permisos: Yup.array().of(Yup.string().required()).min(1, "Seleccione al menos un permiso"),
});
