export const queryKeys = {
  ...
  alumnosBusqueda: (filtro: string, page: number, size: number) =>
    [
      "alumnos",
      "busqueda",
      page,
  ...
  egresos: (page: number, size: number) =>
    ["egresos", page, size, "fecha,desc;id,desc"] as const,
  ...
  stocks: (page: number, size: number) =>
    ["stocks", page, size, "nombre,asc;id,asc"] as const,
